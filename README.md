...
### アライメントが必要な理由
```assembly
; 例: スタックポインタが奇数アドレスの場合
; RSP = 0x7fff12345678 (8バイト境界だが16バイト境界ではない)

and r8, 15                 ; r8 = 0x7fff12345678 & 15 = 8
sub rsp, r8                ; RSP = 0x7fff12345678 - 8 = 0x7fff12345670
                          ; これで16バイト境界に調整完了
```

### アライメント確認の計算
- `and r8, 15`: 下位4ビットを取得（16での余り）
- 結果が0なら既に16バイト境界
- 結果が0以外なら、その分だけスタックを調整する必要がある
